var link_database; var namainstansi; var alamatinstansi;

link_database='api-server/';

namainstansi='SPBU BAWEAN';
alamatinstansi='Bawean, Kabupaten Gresik, Jawa Timur';


adiapp.directive('format', ['$filter', function ($filter) {
    return {
        require: '?ngModel',
