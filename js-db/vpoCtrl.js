adiapp.controller('vpoCtrl', function($scope,$http) {
  ...
  $scope.EditData = function(){
    ...
    $http.post(link_database+"list-po-cud.php",{
        ...
        'jmlbayar':$scope.txtbayar,
        'kurangbayar':parseFloat($scope.txttotal2)-parseFloat($scope.txtbayar),        
...
//    $scope.TmbUpdate=true;
    $http.post(link_database+"list-po-cud.php",{
      ...
      $scope.txttotal=parseFloat($scope.cud[0].total);
      $scope.txttotal2=parseFloat($scope.cud[0].total);
      $scope.txtbayar=parseFloat($scope.cud[0].total);
      ...
      $scope.animation_image=true;
        $scope.isi=data;
          ...
          for (i=0;i<parseFloat($scope.isi.length);i++){
            $scope.totallist=parseFloat($scope.totallist)+parseFloat($scope.isi[0].total);
          }        
